...
TESSERACT_FAST_MODE = True
TESSERACT_FAST_USE_CONFIDENCE = False
...
OCR_ENABLE_LIGHT_TEXT_VARIANT = True
OCR_ENABLE_INVERT_VARIANT = True
OCR_PREPROCESS_BORDER = 12
...
# ============================================================================
CAPTURE_SOURCE = "mss"  # mss | obs_virtual_camera
OBS_CAMERA_INDEX = 0
...
# Быстрый пропуск похожих кадров до OCR
OCR_SKIP_SIMILAR_FRAMES = True
OCR_FRAME_SIGNATURE_HEIGHT = 18
OCR_FRAME_SIGNATURE_WIDTH = 48
OCR_FRAME_SIMILARITY_THRESHOLD = 0.012
...
# ============================================================================
# RNN ФИЛЬТР OCR-ТЕКСТА (Прототип 4)
# ============================================================================
RNN_TEXT_FILTER_ENABLED = False
RNN_TEXT_FILTER_SEQ_LEN = 48
RNN_TEXT_FILTER_HIDDEN_SIZE = 20
RNN_TEXT_FILTER_THRESHOLD = 0.55
RNN_TEXT_FILTER_TRAIN_SAMPLES = 1200
RNN_TEXT_FILTER_EPOCHS = 12
...
CAPTURE_HEALTH_LOG_INTERVAL_SEC = 5.0
OCR_NO_TEXT_WARN_INTERVAL_SEC = 5.0
